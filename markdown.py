...
_ALL_NEGATIVE_TEXT_HINTS = (_COMMENT_MARKERS, _COMMENT_ACTION_MARKERS, _RECOMMENDATION_TAIL_MARKERS, _NAV_RELATIONSHIP_MARKERS, _LEGAL_EDITORIAL_MARKERS, _COMMENT_TAIL_MARKERS, _FEED_META_TRIGGER_FRAGMENTS, ("广告",))
